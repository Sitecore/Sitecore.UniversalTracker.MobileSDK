namespace Sitecore.UniversalTrackerClient.API.Exceptions
{
  ...
  {
        public const string NETWORK_EXCEPTION_MESSAGE = "[Sitecore Universal Tracker SDK] Unable to download data from the internet";
        public const string BAD_USER_REQUEST_MESSAGE = "[Sitecore Universal Tracker SDK] Unable to build HTTP request";
        public const string PARSER_EXCEPTION_MESSAGE = "[Sitecore Universal Tracker SDK] Data from the internet has unexpected format";
